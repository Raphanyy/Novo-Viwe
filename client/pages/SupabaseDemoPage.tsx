      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto py-8">
          ...
          <div className="mt-8 p-6 bg-muted rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Frontend direto → Supabase:</strong> Para operações simples de CRUD, autenticação e realtime
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Frontend → Express → Supabase:</strong> Para lógica de negócio complexa, validações e operações administrativas
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Autenticação unificada:</strong> JWT tokens compartilhados entre frontend e backend
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 p-6 bg-card border border-border rounded-lg">
            <h3 className="text-lg font-semibold mb-3">Variáveis de Ambiente Necessárias:</h3>
