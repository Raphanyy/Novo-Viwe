  ...
  const testimonials = [
    {
      ...
      avatar: "AS",
      text: "O Viwe revolucionou minha rotina de trabalho completamente. Economizo mais de 2 horas por dia visitando clientes.",
      rating: 5,
      company: "TechCorp",
    },
    {
      ...
      avatar: "CM",
      text: "Melhor aplicativo de rotas que já utilizei na vida. A previsão de trânsito é incrivelmente precisa sempre.",
      rating: 5,
      company: "Uber",
    },
    {
      ...
      role: "Empresária",
      avatar: "MC",
      text: "Nossa frota reduziu 25% no consumo de combustível. As rotas otimizadas do Viwe fizeram toda diferença.",
      rating: 5,
      company: "LogiTrans",
    },
  ];
