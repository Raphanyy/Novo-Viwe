          ...
          <Card>
            ...
            <CardContent>
              {isAuthenticated && user ? (
                ...
                <p className="text-muted-foreground text-sm">Nenhum usuário logado</p>
              )}
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                <strong>🎉 Autenticação Real Ativada!</strong><br/>
                O sistema agora usa autenticação real com Supabase. Você pode:
